...
if [[ ${PWD} -ef ${GOPATH}/src/github.com/ctylim/certificate-transparency-go/trillian/integration ]]; then
...
sed "s~@TESTDATA@~${GOPATH}/src/github.com/ctylim/certificate-transparency-go/trillian/testdata~" ${GOPATH}/src/github.com/ctylim/certificate-transparency-go/trillian/integration/demo-script.cfg > demo-script.cfg
...
tree_id=$(./createtree --admin_server=localhost:6962 --private_key_format=PrivateKey --pem_key_path=${GOPATH}/src/github.com/ctylim/certificate-transparency-go/trillian/testdata/log-rpc-server.privkey.pem --pem_key_password=towel --signature_algorithm=ECDSA)
echo ${tree_id}
...
go build github.com/ctylim/certificate-transparency-go/trillian/ctfe/ct_server
...
go build github.com/ctylim/certificate-transparency-go/trillian/integration/ct_hammer

echo 'Hammer time'
./ct_hammer --log_config demo-script.cfg --ct_http_servers=localhost:6965 --mmd=30s --testdata_dir=${GOPATH}/src/github.com/ctylim/certificate-transparency-go/trillian/testdata --logtostderr &
hammer_pid=$!
...
echo 'Provision a log and remember the its tree ID'
tree_id_2=$(./createtree --admin_server=localhost:6962 --private_key_format=PrivateKey --pem_key_path=${GOPATH}/src/github.com/ctylim/certificate-transparency-go/trillian/testdata/log-rpc-server.privkey.pem --pem_key_password=towel --signature_algorithm=ECDSA)
echo ${tree_id_2}
...
./ct_hammer --log_config demo-script-2.cfg --ct_http_servers=localhost:6965 --mmd=30s --testdata_dir=${GOPATH}/src/github.com/ctylim/certificate-transparency-go/trillian/testdata --logtostderr &
hammer_pid=$!
...
${GOPATH}/src/github.com/ctylim/certificate-transparency-go/trillian/integration/ct_killall.sh
